export default {
  ...
  scan: {
    ...
    productNotFoundDesc: 'Sorry, the barcode was not found in the database. Please try another product.',
    unexpectedError: 'An unexpected error occurred during scanning.',
    scanUseErrorDesc: 'An unexpected error occurred while trying to use a scan credit. Please try scanning again.',
    watchAdPrompt: 'Watch an ad to get more scans?',
  ...
  product: {
    ...
    nutriments: {
      ...
      fat: 'Fat: {{value}}{{unit}}',
      sugars: 'Sugars: {{value}}{{unit}}',
      'saturated-fat': 'Saturated Fat: {{value}}{{unit}}',
      fiber: 'Fiber: {{value}}{{unit}}',
      sodium: 'Sodium: {{value}}{{unit}}',
      salt: 'Salt: {{value}}{{unit}}',
    },
    nutriScore: 'Nutri-Score',
    allergenWarning: 'Appliable Allergens',
  ...
  ads: {
    ...
    rewarded: 'Scans Added!',
    rewardedDesc: 'You received {{count}} extra scans!',
    ok: 'OK',
    notInitialized: 'Ads Not Ready',
    notInitializedDesc: 'The ad service is not yet ready. Extra scans granted automatically!',
    notReady: 'Ad Not Ready',
    notReadyDesc: 'The ad could not be loaded in time. Extra scans granted automatically!',
    loadError: 'Ad Load Error',
    loadErrorDesc: 'There was an error loading the ad. Extra scans granted automatically!',
    completionError: 'Ad Not Completed',
    completionErrorDesc: "The ad didn't finish successfully, so no extra scans were added. Please try watching the ad again.",
    showError: 'Ad Display Error',
    showErrorDesc: "Could not display the ad due to an error. No extra scans were added. Please check your connection and try again.",
    grantError: 'Reward Grant Error',
    grantErrorDesc: "The ad finished, but there was an issue updating your scan count. If the count seems incorrect, please try restarting the app.",
  },
  common: {
    cancel: 'Cancel',
    ok: 'OK',
  ...
  updates: {
    ...
    downloadedMessage: 'Update downloaded. It will be applied next time you open the app.',
    restart: 'Restart Now',
    later: 'Later',
