...
module.exports = ({ config }) => {
    ...
    const newVersion = '1.15'; // Incremented version
    const newAndroidVersionCode = 15; // Incremented versionCode
    const newiOSBuildNumber = '15'; // Incremented buildNumber
    ...
    return {
        ...
        extra: {
            ...
            FOOD_REPO_API_KEY: process.env.FOOD_REPO_API_KEY,
            ...
            ADMOB_IOS_REWARDED_AD_UNIT_ID: process.env.ADMOB_IOS_REWARDED_AD_UNIT_ID,
            ADMOB_ANDROID_APP_ID: process.env.ADMOB_ANDROID_APP_ID,
            ADMOB_ANDROID_REWARDED_AD_UNIT_ID: process.env.ADMOB_ANDROID_REWARDED_AD_UNIT_ID,
            ADMOB_IOS_INTERSTITIAL_AD_UNIT_ID: process.env.ADMOB_IOS_INTERSTITIAL_AD_UNIT_ID,
            ADMOB_ANDROID_INTERSTITIAL_AD_UNIT_ID: process.env.ADMOB_ANDROID_INTERSTITIAL_AD_UNIT_ID,
        },
    };
};
